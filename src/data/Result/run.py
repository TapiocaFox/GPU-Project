#!/usr/bin/env python3
"""
Compile and run all CUDA kernels in data_b5_t15 directory
...
def parse_output(output: str) -> Optional[Tuple[float, float]]:
    ...
    """
    # Look for pattern [number, number] - supports scientific notation
    # Pattern matches: digits, decimal point, optional exponent (e/E followed by +/- and digits)
